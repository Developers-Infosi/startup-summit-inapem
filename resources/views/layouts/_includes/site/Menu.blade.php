                ...
                <div class="row no-gutters d-flex align-items-center">
                    <div class="col-sm-2 col-xs-12">
                        <div class="site-branding">
                            <a class="dark-logo" href="{{ route('site.home') }}"><img
    ...
    <div class="rt-header-menu mean-container" id="meanmenu">
        <div class="mean-bar">
            <a href="{{ route('site.home') }}"
                alt="Eventalk - Event Conference WordPress Theme"><img width="489" height="121"
                    class="logo-small" alt="Eventalk - Event Conference WordPress Theme"
