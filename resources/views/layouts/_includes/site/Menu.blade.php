                ...
                <div class="col-sm-2 col-xs-12">
                    <div class="site-branding">
                        <a class="dark-logo" href="{{ route('site.home') }}">
                            <img width="360" height="112" src="/site/images/logo/logo.png"
                                alt="Eventalk - Event Conference WordPress Theme" loading="lazy" />
                        </a>
                        <a class="light-logo" href="{{ route('site.home') }}">
                            <img width="360" height="112" src="/site/images/logo/footerlogo.png" loading="lazy" />
                        </a>
                    </div>
                </div>
...
<div class="rt-header-menu mean-container" id="meanmenu">
    <div class="mean-bar">
        <a href="{{ route('site.home') }}" alt="Fórum">
            <img width="489" height="121" class="logo-small" alt="Fórum" src="/site/images/logo/logo.png" />
        </a>
