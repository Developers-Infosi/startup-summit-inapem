                        ...
                        <div class="breadcrumb-area">
                            <div class="entry-breadcrumb">
                                ...
                                <span property="itemListElement" typeof="ListItem">
                                    <a property="item" typeof="WebPage" title="Angotic" href="#" class="home">
                                        <span property="name">ANGOTIC</span>
                                    </a>
                                    <meta property="position" content="1">
                                </span>
                                &gt;
                                <span property="itemListElement" typeof="ListItem">
                                    <a property="item" typeof="WebPage" title="Galeria" href="{{ route('site.gallery') }}"
                                        class="home">
